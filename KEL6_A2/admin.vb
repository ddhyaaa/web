...
Imports System.IO
Imports System.Text.RegularExpressions ' Tambahkan ini untuk validasi regex
...
Public Class update
    ...
    Private Sub btn_Ubah_Click(sender As Object, e As EventArgs) Handles btn_Ubah.Click
        ...
        If Not IsNameValid(nama.Text) Then
            MessageBox.Show("Nama harus berupa huruf.")
            Exit Sub
        End If

        If password.Text.Length < 5 Then
            MessageBox.Show("Panjang password minimal 5 karakter.")
            Exit Sub
        End If
